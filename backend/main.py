...
app = FastAPI(
    ...
    description="SubscriptionBox: Subscription box service with recurring orders and curation",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "subscriptionbox"}
